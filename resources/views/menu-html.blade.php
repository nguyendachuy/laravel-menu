...
<div id="nguyen-huy" class="bg-white shadow rounded-lg border border-gray-200 mb-6">
    <div class="px-4 py-3 border-b border-gray-200 bg-gray-50 flex items-center">
        <form method="GET" action="{{ $currentUrl }}" class="flex flex-wrap items-center">
            <label for="menu-selector" class="mr-2">Select the menu you want to edit: </label>
            ...
            <button type="submit" class="ml-2 bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-300">Submit</button>
            <div class="ml-4">
                or <a href="{{ $currentUrl }}?action=edit&menu=0" class="text-blue-600 hover:underline">Create New Menu</a>
            </div>
        </form>
    </div>
                    ...
                    <div class="bg-white shadow rounded border border-gray-200">
                        <div class="p-5">
                            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-4">
                                Please select a menu from the dropdown or create a new one.
                            </div>
                        </div>
                    </div>
                @endif
