<li class="dd-item" data-id="{{$item['id']}}" data-depth="{{isset($depth) ? $depth : 0}}" data-parent="{{$item['parent'] ?? 0}}">
    ...
    <div class="menu-item-settings bg-gray-50 border border-gray-200 p-4 mt-1 mb-3 rounded hidden" id="settings-{{$item['id']}}">
        <div class="mb-3">
            <label class="block mb-1 text-sm font-medium text-gray-700" for="label-menu-{{$item['id']}}">Navigation Label</label>
        ...
        <div class="mb-3">
            <label class="block mb-1 text-sm font-medium text-gray-700" for="url-menu-{{$item['id']}}">URL</label>
        ...
        <div class="mb-3">
            <label class="block mb-1 text-sm font-medium text-gray-700" for="clases-menu-{{$item['id']}}">CSS Class (optional)</label>
        ...
        <div class="mb-3">
            <label class="block mb-1 text-sm font-medium text-gray-700" for="icon-menu-{{$item['id']}}">Icon Class (optional)</label>
        ...
        <div class="mb-3">
            <label class="block mb-1 text-sm font-medium text-gray-700" for="target-menu-{{$item['id']}}">Link Target</label>
